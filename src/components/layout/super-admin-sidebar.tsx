...
const navSections = [
  ...
  {
    label: "Insights",
    items: [{ href: "/super-admin/analytics", label: "Analytics", icon: BarChart3 }],
  },
  {
    label: "System",
    items: [{ href: "/super-admin/settings", label: "Settings", icon: Settings }],
  },
];
    ...
    <>
      ...
      >
        <div className="flex h-16 items-center justify-between border-b px-5">
          <Link href="/super-admin" className="flex items-center gap-3" onClick={onClose}>
        ...
        <div className="border-t p-4">
          <div className="rounded-lg bg-muted/50 px-3 py-2.5">
            <p className="text-xs font-medium">Platform Control</p>
            <p className="text-[11px] text-muted-foreground">Manage hospitals & users</p>
          </div>
        </div>
      </aside>
    </>
